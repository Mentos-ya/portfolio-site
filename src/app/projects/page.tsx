    ...
    <div className="max-w-4xl mx-auto px-6 py-20">
      ...
      <div className="space-y-12">
        ...
        <div className="border-b border-ink/15 pb-12 last:border-b-0">
          ...
          <p className="text-ink mb-4">Product Manager & Growth PM | 2018 - Июнь 2025</p>
          ...
          <ul className="text-ink space-y-1 mb-6">
          ...
          <div className="flex flex-wrap gap-2">
            {['Lean Canvas', 'User Research', 'A/B Testing', 'Amplitude', 'Asana', 'Notion', 'amoCRM', 'API Integration', 'Telegram Bot', 'Funnel Analysis'].map((skill) => (
              <span key={skill} className="px-3 py-1 bg-paper-card border border-ink/15 text-ink rounded-full text-sm">
                {skill}
              </span>
            ))}
          </div>
      ...
      <div className="mt-16 pt-12 border-t border-ink/15">
        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="text-ink text-sm">Различные проекты | 7+ лет опыта</p>
