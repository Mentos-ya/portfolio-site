...
export default function LetoPlacePage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-12">
      ...
      <Link
        href="/#projects"
        className="inline-flex items-center text-zinc-400 hover:text-white transition mb-10 group"
      >
      ...
      <div className="flex flex-col md:flex-row md:flex-nowrap items-start md:items-center justify-between gap-y-0 gap-x-4 w-full mb-10 text-lg text-zinc-400">
      ...
      <div className="mb-14">
        ...
        <div className="grid grid-cols-2 gap-3">
          <a href="#b2b-segment" className="px-4 py-3 rounded-lg border border-night-edge bg-night-card hover:border-purple-400/60 hover:bg-white/5 text-center font-medium transition">
            B2B-сегмент
          </a>
          <a href="#b2c-segment" className="px-4 py-3 rounded-lg border border-night-edge bg-night-card hover:border-purple-400/60 hover:bg-white/5 text-center font-medium transition">
            B2C-сегмент
          </a>
          <a href="#unit-economics" className="px-4 py-3 rounded-lg border border-night-edge bg-night-card hover:border-purple-400/60 hover:bg-white/5 text-center font-medium transition">
            Юнит-экономика
          </a>
          <a href="#automation" className="px-4 py-3 rounded-lg border border-night-edge bg-night-card hover:border-purple-400/60 hover:bg-white/5 text-center font-medium transition">
      ...
      <div id="b2b-segment" className="mb-14 scroll-mt-28">
        ...
        <div className="space-y-3 text-zinc-300 mb-6">
          <p className="leading-relaxed">
            ...
            <span className="text-white font-medium">Работа с собственниками недвижимости</span>: долгосрочная аренда «под ключ», управление объектами, прозрачная отчётность по доходам и автоматизация процессов для масштабирования портфеля.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-[1fr_auto] gap-8 items-stretch">
          ...
          <a
            ...
            className="group shrink-0 relative flex w-full md:w-[190px] h-full min-h-0 rounded-xl border border-night-edge hover:border-purple-400/60 overflow-hidden shadow-md hover:shadow-lg transition mx-auto md:mx-0"
          >
      ...
      <div id="b2c-segment" className="mb-14 scroll-mt-28">
        ...
        <div className="space-y-3 text-zinc-300 mb-6">
          <p className="leading-relaxed">
            <span className="text-white font-medium">Работа с путешественниками</span>: краткосрочная аренда, удобный поиск и бронирование, качество размещения и сервиса для гостей, оптимизация загрузки и ценообразования.
          </p>
        </div>
        ...
        <ul className="mt-3 space-y-3 text-zinc-300 w-full">
          <li className="flex gap-3 items-start">
            <span className="text-purple-400 font-bold mt-0.5 shrink-0">•</span>
      ...
      <div className="mb-14 hidden md:block">
        ...
        <div className="flex flex-wrap gap-2">
          {project.tools.map((tool) => (
            <span
              key={tool}
              className="px-4 py-2 bg-night-card border border-night-edge text-zinc-300 rounded-full text-sm font-medium hover:bg-white/5 transition"
            >
              {tool}
            </span>
          ))}
