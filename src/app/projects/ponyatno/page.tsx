...
export default function PonyatnoPage() {
  return (
    <div className="max-w-4xl mx-auto px-6 py-12">
      ...
      {/* Discovery & CustDev */}
      <div className="mb-6">
        <p className="text-base font-semibold text-white mb-2">Discovery & CustDev</p>
      ...
      <div className="mb-6">
        <p className="text-base font-semibold text-white mb-2">Приоритизация & Дизайн</p>
        <ul className="space-y-2 text-zinc-300 text-sm leading-relaxed">
          <li className="flex gap-3 items-start">
            <span className="text-purple-400 font-bold mt-0.5 shrink-0">•</span>
        ...
        <div className="relative w-full max-w-full md:max-w-[294px] mx-auto md:ml-auto md:mr-0 aspect-[9/16] min-h-[336px] rounded-lg border border-night-edge shadow-md overflow-hidden bg-black order-first md:order-none">
            <video
              controls
      ...
      <div className="w-full mt-0">
        <div className="mb-6">
          <p className="text-base font-semibold text-white mb-2">Запуск & Итерации</p>
          <ul className="space-y-2 text-zinc-300 text-sm leading-relaxed">
            <li className="flex gap-3 items-start">
              <span className="text-purple-400 font-bold mt-0.5 shrink-0">•</span>
        ...
        <section className="mb-6">
          <p className="text-base font-semibold text-white mb-2">Стек проекта</p>
          <div className="flex flex-wrap gap-2 w-full">
            {[
              ...
              <span
                key={item}
                className="px-3 py-1.5 bg-night-card border border-night-edge text-zinc-300 rounded-full text-xs font-medium"
              >
                {item}
              </span>
            ))}
