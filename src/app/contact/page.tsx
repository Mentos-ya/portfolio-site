            ...
            <div>
              ...
              <div className="relative inline-block group">
                <a
                  ...
                  className="text-ink underline hover:underline text-lg"
                >
                  https://t.me/iak_ilia
                </a>
                <span className="absolute left-0 top-full mt-1 px-2 py-1 bg-black text-ink text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">
                  Открыть Telegram
                </span>
              </div>
            </div>
